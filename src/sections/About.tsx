...
export function About({ part, active }: { part: number; active: boolean }) {
  return <div className={`about about-part-${part}`}>
    ...
    {part === 1 && <><div className="about-video"><Landscape media={assets.about[1]} active={active} /></div><p className="about-second">{about.second}</p><p className="about-third">{about.third}</p></>}
